...
from report_modifier import modify_cleanup, modify_line_in_report, modify_processed, modify_progress, modify_remaining, modify_violations
...
def main():
    ...
    for a in urls:
        ...
        print("progress to " + str((urls.index(a)+1) / len(urls) * 100))
